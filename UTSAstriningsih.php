<html>
<body>
<form action="Astriningsih.php" method="post">
<?php
...
No. Faksimili		: <input type="text" name="nofaksimili" />
			...
			<input type="Submit"/ name="Send" value="Send"/><input type="Submit"/name="Reset" value="Resetsssss"/>
			</form>
			<form action="UTSAstriningsih.php">
</pre>
